...
const YourDentist = () => {
    return (
        <div className='w-full bg-[#F4F6F3] min-h-[60vh] pt-10 pb-20'>
            <motion.div 
                className='w-[80%] mx-auto md:flex md:flex-wrap lg:flex-nowrap justify-between items-center'
            ...
            >
                ...
                <motion.div 
                    ...
                    viewport={{ once: true }}
                >
                    <p className='text-[100px] font-[800] text-[#d7e0e9] flex flex-col'>
                        Your <span className='-mt-[70px]'>Dentist</span> 
                    </p>
                    <h1 className='text-5xl -mt-14 text-[#104B82] font-semibold'>Dr. Abel Mekonn</h1>
                    <p className='font-heading text-[20px] mt-8'>
